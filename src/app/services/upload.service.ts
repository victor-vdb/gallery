  ...
  uploadFile(upload: Upload) {
    ...
    uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED,
      ...
      (): any => {
        ...
        upload.galleryUrl = 'https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=300&url=' + encodeURIComponent(uploadTask.snapshot.downloadURL);
